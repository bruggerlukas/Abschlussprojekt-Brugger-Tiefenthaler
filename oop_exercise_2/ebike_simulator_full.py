...
class EBikeSimluator:
    ...
    def __init__(self, battery: BatteryBase, motor: Motor, vehicle_model: VehicleModel) -> None:
...
if __name__ == "__main__":
    ...
    motor = Motor()
    bike = VehicleModel(mass_kg=80+15, drive_efficiency=0.9)

    sim = EBikeSimluator(battery, motor, bike)
